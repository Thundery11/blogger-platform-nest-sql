...
describe('Public quiz testing', () => {
  ...
  describe('Users creation and authentication', () => {
    ...
    it('should log in user 03', async () => {
      const response = await agent
        .post(publicLoginUri)
        .send({ loginOrEmail: user03Login, password: userPassword })
        .expect(200);
    ...
    it('should log in user 04', async () => {
      const response = await agent
        .post(publicLoginUri)
        .send({ loginOrEmail: user04Login, password: userPassword })
        .expect(200);
  ...
  describe('01 game create and connect operations', () => {
    ...
    it('should return 401 when trying to create game with invalid token', async () => {
      return agent
    ...
    //Success
    it('should create new game with panding user 02', async () => {
      const response = await agent
        .post(publicGameConnectionURI)
    ...
    it('should create and publish 10 questions', async () => {
      ...
      for (let i = 1; i < 11; i++) {
        ...
        console.log('🚀 ~ it ~ response:', response.body.correctAnswers);
        await agent
    ...
    it('should return 403 when user 01 already in game', async () => {
      return await agent
        .post(publicGameConnectionURI)
        .auth(aTokenUser01, { type: 'bearer' })
        .expect(403);
    });
    it('should return 403 when user 01 trying to send answer', async () => {
      return await agent
        .post(publicAnswersURI)
        .auth(aTokenUser01, { type: 'bearer' })
        .send({ answer: correctAnswer01 })
        .expect(403);
    });
    it('should return 403 when user 02 trying to send answer', async () => {
      return await agent
        .post(publicAnswersURI)
    ...
    it('should return 403 when user 03 is trying to get the game, that he is not participating', async () => {
      return await agent
  ...
  describe('01 Answers operations', () => {
    ...
    it('should return 400 when user trying to send asnswer without body', async () => {
      return agent
        .post(publicAnswersURI)
        .auth(aTokenUser01, { type: 'bearer' })
        .send({})
    ...
    it('should return 400 , when user trying to send incorrect answer type', async () => {
      return agent
        .post(publicAnswersURI)
        .auth(aTokenUser01, { type: 'bearer' })
        .send({ answer: 234 })
    ...
    it('should return 401 when user trying to answer with incorrect token', async () => {
      return agent
        .post(publicAnswersURI)
        .auth(randomUUID(), { type: 'bearer' })
        .send({ answer: correctAnswer01 })
    ...
    //      Forbidden errors [403]
    it('should return 403 when third user trying to send answer', async () => {
      return agent
        .post(publicAnswersURI)
        .auth(aTokenUser03, { type: 'bearer' })
        .send({ answer: correctAnswer01 })
